...
def test_fixture_account_card(card):
...
def test_parametrize_account_card(card_details, expected):
    result = mask_account_card(card_details)
    assert result == expected
...
@pytest.mark.parametrize("input_date, expected", [
    ...
    ('2024- -11T02:26:18.671407', 'Ошибка ввода данных'),
    ('', 'Ошибка ввода данных')])
def test_parametrize_get_date(input_date, expected):
